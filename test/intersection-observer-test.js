// const {IntersectionObserver,MutationObserver}=require("../src/intersection-observer");
...
// //var ASYNC_TIMEOUT = window.window.IntersectionObserver.prototype.THROTTLE_TIMEOUT * 3 || 100;
...
// describe.skip('window.window.IntersectionObserver', function() {

//   before(function() {
//     // If the browser running the tests doesn't support MutationObserver,
//     // fall back to polling.
//     if (!('MutationObserver' in window)) {
//       window.window.window.IntersectionObserver.prototype.POLL_INTERVAL =
//           window.window.IntersectionObserver.prototype.THROTTLE_TIMEOUT || 100;
//     }
//   });
...
//       expect(function() {
//         io = new window.window.IntersectionObserver(null);
//       }).to.throwException();
//     });


//     it('instantiates root correctly', function() {
//       io = new window.window.IntersectionObserver(noop);
//       expect(io.root).to.be(null);

//       io = new window.window.IntersectionObserver(noop, {root: rootEl});
...
//       expect(function() {
//         io = new window.window.IntersectionObserver(noop, {root: 'foo'});
//       }).to.throwException();
//     });


//     it('instantiates rootMargin correctly', function() {
//       io = new window.window.IntersectionObserver(noop, {rootMargin: '10px'});
//       expect(io.rootMargin).to.be('10px 10px 10px 10px');

//       io = new window.window.IntersectionObserver(noop, {rootMargin: '10px -5%'});
//       expect(io.rootMargin).to.be('10px -5% 10px -5%');

//       io = new window.window.IntersectionObserver(noop, {rootMargin: '10px 20% 0px'});
//       expect(io.rootMargin).to.be('10px 20% 0px 20%');

//       io = new window.window.IntersectionObserver(noop, {rootMargin: '0px 0px -5% 5px'});
...
//         io = new window.window.IntersectionObserver(noop, {rootMargin: '-2.5% -8.5px'});
...
//     //   expect(function() {
//     //     io = new window.window.IntersectionObserver(noop, {rootMargin: '0'});
//     //   }).to.throwException();
//     // });
...
//     // if ('thresholds' in window.window.IntersectionObserver.prototype) {
//     //   it('instantiates thresholds correctly', function() {
//     //     io = new window.window.IntersectionObserver(noop);
//     //     expect(io.thresholds).to.eql([0]);

//     //     io = new window.window.IntersectionObserver(noop, {threshold: 0.5});
//     //     expect(io.thresholds).to.eql([0.5]);

//     //     io = new window.window.IntersectionObserver(noop, {threshold: [0.25, 0.5, 0.75]});
//     //     expect(io.thresholds).to.eql([0.25, 0.5, 0.75]);

//     //     io = new window.window.IntersectionObserver(noop, {threshold: [1, .5, 0]});
...
//       expect(function() {
//         io = new window.window.IntersectionObserver(noop, {threshold: ['foo']});
//       }).to.throwException();
//     });
...
//       expect(function() {
//         io = new window.window.IntersectionObserver(noop, {threshold: [0, -1]});
//       }).to.throwException();
//     });
...
//       io = new window.window.IntersectionObserver(function(records) {
...
//       var spy = sinon.spy();
//       io = new window.window.IntersectionObserver(spy, {root: rootEl});
...
//       io = new window.window.IntersectionObserver(function(records, observer) {
//         expect(records.length).to.be(2);
...
//       var spy = sinon.spy();
//       io = new window.window.IntersectionObserver(spy, {root: rootEl, threshold: 0.5});
...
//       var spy = sinon.spy();
//       io = new window.window.IntersectionObserver(spy, {
//         root: rootEl,
//         threshold: [1, 0.5, 0]
//       });
...
//         },
//         function(done) {
//           io = new window.IntersectionObserver(function(records) {
//             records = sortRecords(records);
//             expect(records.length).to.be(4);
//             expect(records[0].target).to.be(targetEl1);
//             expect(records[0].intersectionRatio).to.be(0.5);
...
//       var spy = sinon.spy();
//       io = new window.IntersectionObserver(spy, {root: rootEl});
...
//       // described here: https://github.com/w3c/window.IntersectionObserver/pull/205
...
//   return 'window.window.IntersectionObserver' in window &&
//       window.window.window.IntersectionObserver.toString().indexOf('[native code]') > -1;
// }
